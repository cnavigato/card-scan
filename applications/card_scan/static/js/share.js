...
jQuery(function(){
	var script_source = jQuery('script[src*="share.js"]').attr('src');
     ...
     //yelp http://www.yelp.com/biz/jurupa-valley-recycling-riverside
    //https://plus.google.com/105171083311725550969/about
    //https://www.facebook.com/chris.navigato.5?fref=ts
    //https://twitter.com/JvrRecycling
	...
	st.css({'opacity':'.7','z-index':'3000','background':'#FFF','border':'solid 1px #666','border-width':' 1px 0 0 1px','height':'25px','width':'50px','position':'fixed','bottom':'0','right':'0','padding':'2px 5px','overflow':'hidden','-webkit-border-top-left-radius':' 12px','-moz-border-radius-topleft':' 12px','border-top-left-radius':' 12px','-moz-box-shadow':' -3px -3px 3px rgba(0,0,0,0.5)','-webkit-box-shadow':' -3px -3px 3px rgba(0,0,0,0.5)','box-shadow':' -3px -3px 3px rgba(0,0,0,0.5)'});
	...
	st.mouseleave(function(){ 
	    st.animate({height:'25px', width: '40px', opacity: .7}, 300); 
	    jQuery('#socialdrawer img').hide();
	    return false;
	    }  );
    });
